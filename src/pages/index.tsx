  ...
  return (
    <>
      ...
      <div className="w-full bg-[#913133] flex items-center justify-center h-auto lg:h-[597px] border-b border-white bg-background text-white p-5">
        <div className="w-full max-w-[1720px] min-w-[300px] mx-auto flex flex-col lg:flex-row banner:justify-between lg:px-[120px] banner:items-center text-center lg:text-left">
          <div className="p-5 p-lateral:p-0 relative flex flex-col items-center lg:items-start">
            <div className="Heading-Primary-Heading-2 text-white hyphens-auto w-full lg:w-[550px] text-center lg:text-left">
              Dra. Gabriela e Dra. Luciene <br />
            </div>
            <span className="text-[28px] lg:text-[35px] text-normal mt-2">
              Advogadas Associadas
            </span>
            <div className="Body-Regular-Body-1 mt-[16px] text-justify hyphens-auto w-full lg:w-[550px] px-4 lg:px-0">
            ...
            <div className="flex flex-col lg:flex-row gap-[15px] mt-[24px] banner:justify-start justify-center">
              <a href="#contatos">
                <button className="fill-large-default text-[#913133] bg-white px-4 py-2 rounded-md">
                  Fale conosco
                </button>
              </a>
              <a href="#sobre-nos">
                <button className="outline-large-default text-white border border-white px-4 py-2 rounded-md">
                  Sobre nós
                </button>
              </a>
            </div>
            <div className="mt-[24px] flex flex-col text-center lg:text-left justify-center items-center lg:flex-row lg:items-start lg:justify-start">
      ...
      >
        <div className="w-full max-w-[1500px] min-w-[300px] mx-auto flex flex-col ">
          <div className="container mx-auto">
            <div className="lg:grid lg:grid-cols-1 center text-center lg:items-center xl:gap-[117px] gap-[22px] flex flex-col h-[250px] mb-[60px] sm:mb-[50px]">
              <div>
            ...
            <div className="items-center flex flex-col">
              <div className="lg:grid lg:grid-cols-2 lg:gap-0 gap-[20px]  items-center flex flex-col lg:w-full w-[90%]">
                <div>
                  ...
                  <div className="body-regular-lg text-white lg:w-[80%] w-full text-justify hyphens-auto">
          ...
          <div className="container mx-auto">
            <div className="lg:grid lg:grid-cols-1 gap-[60px] items-center flex flex-col-reverse ">
              {/* <div className="w-full max-w-[1500px] min-w-[300px] mx-auto flex flex-col p-6">
                <div className="container mx-auto"> */}
              <div className="lg:grid lg:grid-cols-2 gap-[30px] lg:gap-[60px] items-start flex flex-col-reverse">
                <div className="flex flex-col space-y-5 w-full">
                  <h2 className="Heading-Primary-Heading-3 text-[#913133] mb-[7px]">
                    Contato
                  </h2>

                  <div className="flex flex-col gap-[30px] mb-[50px] lg:mb-[100px]">
                    {/* Email Contacts - Responsive */}
                    <div className="flex flex-col lg:flex-row gap-[20px] lg:items-center">
                      <div className="flex flex-col lg:flex-row gap-[20px] w-full lg:w-auto items-center">
                        {/* Direito Trabalhista */}
                        ...
                        <div className="hidden lg:block border-[1px] bg-black h-[50px]"></div>
                        ...
                        <div className="flex gap-[12px] items-center flex-1">
                          ...
                          <div>
                            <div className="font-bold text-[#913133] w-full whitespace-nowrap">
                  ...
                  {/* Social Media */}
                  <div className="mt-[50px] lg:mt-[220px]">
                      ...
                      >
                        ...
                        >
                          <rect
                            ...
                            fillOpacity="0.08"
                          />
                          <g clipPath="url(#clip0_2323_1260)">
                            <path
